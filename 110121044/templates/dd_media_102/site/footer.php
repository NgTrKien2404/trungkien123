...
<a href="mailto:<?php echo $document->params->get('f8'); ?>" draggable="false">
<?php echo $document->params->get('fo8'); ?></a>
<br><a href="mailto:<?php echo $document->params->get('f9'); ?>" draggable="false">
<?php echo $document->params->get('fo9'); ?>
 ...
 col-sm-12">
    ...
    <div class="bd-container-inner bd-margins clearfix">
        <?php
    renderTemplateFromIncludes('joomlaposition_32');
?>
    </div>
</section>
...
<?php echo date("Y");?> Copyright © <?php echo $document->params->get('footer1'); ?> ALL RIGHTS RESERVED.
