...
<div class=" bd-vmenu-1" data-responsive-menu="true" data-responsive-levels="">
    <div class=" bd-block-2 <?php echo $params->get('moduleclass_sfx'); ?>">
        <?php if ($hasCaption) : ?>
        <div class=" bd-container-14 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table">
            <h4><?php echo $caption; ?></h4>
        </div>
        <?php endif; ?>
        <div class=" bd-container-34 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table shape-only">
