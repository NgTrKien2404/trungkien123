...
class JFormFieldTFDimensionControl extends JFormFieldText
{
    ...
    {
        JHtml::script('plg_system_nrframework/autosize-input.js', ['relative' => true, 'version' => 'auto']);
        JHtml::stylesheet('plg_system_nrframework/controls/dimension.css', ['relative' => true, 'version' => 'auto']);
