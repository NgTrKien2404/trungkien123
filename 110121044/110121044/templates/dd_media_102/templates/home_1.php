...
?>
		...
		<?php if ($wic == 1 | $wic == 2 ) { ?><?php include("$themeDir/site/welcome.php"); ?><?php } ?>
...
?>
		...
		<?php if ($aic == 1 | $aic == 2) { ?><?php include("$themeDir/site/about.php"); ?><?php } ?>
...
?>
		...
		<?php if ($iic == 1 | $iic == 2) { ?><?php include("$themeDir/site/info.php"); ?><?php } ?>
...
?>
		...
		<?php if ($dsb == 1 | $dsb == 2) { ?><?php include("$themeDir/site/stats.php"); ?><?php } ?>
