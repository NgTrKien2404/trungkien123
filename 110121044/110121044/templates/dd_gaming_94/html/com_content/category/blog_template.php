...
<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-119 bd-tagstyles">
...
<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-92 bd-tagstyles">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
...
<?php if ($categoryInfo) : ?>
    <div class=" bd-container-103 bd-tagstyles">
    <?php echo $categoryInfo; ?>
</div>
<?php endif; ?>
...
<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-87 bd-tagstyles">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
...
<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-78 bd-tagstyles">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
...
<?php if ($categoryTitle) : ?>
    <h2 class=" bd-container-82 bd-tagstyles">
    <?php echo $categoryTitle; ?>
</h2>
<?php endif; ?>
