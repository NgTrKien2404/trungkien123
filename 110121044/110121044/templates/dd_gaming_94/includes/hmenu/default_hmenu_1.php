...
$megamenuClass = 'bd-has-megamenu bd-megamenu bd-megamenu-xs';
$megamenuSubCatItemClass = 'bd-sub-item bd-mega-item  bd-menuitem-64';
...
ob_start();
?>
<div class="bd-menu-4  bd-no-margins bd-mega-grid bd-grid-66">
...
ob_start();
?>
<div class="bd-menuitem-4 bd-sub-item bd-mega-item  bd-menuitem-62 separated-item-55">
    <div class="bd-griditem-55 bd-grid-item">
<?php
