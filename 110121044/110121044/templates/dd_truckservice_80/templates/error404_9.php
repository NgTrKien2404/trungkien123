...
<head>
    ...
    ?>
    <link href="<?php echo $document->params->get('fav'); ?>" />
    <script>
...
<body class=" bootstrap bd-body-9 bd-pagebackground">
    <div class="container  bd-containereffect-16"><div class=" bd-layoutbox-28 clearfix">
    <div class="bd-container-inner">
        <img class="bd-imagestyles-86 bd-imagelink-17   " src="<?php echo JURI::base() . 'templates/' . JFactory::getApplication()->getTemplate(); ?>/images/designer/error.png">
    </div>
</div>
</div>
</body>
