...
<div data-slider-id="product_slider" class=" bd-productsslider-1" data-elements-per-row="<?php echo $products_per_row; ?>">
    <div class="bd-container-inner">
        <div class=" bd-block-20 <?php echo $params->get('moduleclass_sfx'); ?>">
            <?php if ($hasCaption) : ?>
            <div class=" bd-container-85 bd-tagstyles">
                <h4><?php echo $caption; ?></h4>
            </div>
            <?php endif; ?>
            <div class=" bd-container-86 bd-tagstyles shape-only">
                ...
                if (!(VmConfig::get('askprice', true) and empty($tmpPrice))) {
                    if (isset($product->orderable) && $product->orderable) {
                        ...
                        $button = JHTML::link ($product->link, JText::_ ('COM_VIRTUEMART_CART_ADD_TO'),
                            array('title' => $product->product_name, 'class' => ' bd-productbuy-1 bd-button'));
