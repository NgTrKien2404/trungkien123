...
?>
<div class="nrf-widget openstreetmap map-widget map-editor nr-address-component<?php echo $options['css_class']; ?>" id="<?php echo $options['id']; ?>" data-options="<?php echo htmlspecialchars(json_encode($options)); ?>">
	...
	<?php } ?>
	<?php if (!$options['required']): ?>
	<div class="tf-map-editor-clear-wrapper"><a href="#" class="tf-map-editor-clear"><?php echo JText::_('NR_CLEAR'); ?></a></div>
	<?php endif; ?>
	<?php
	...
	{
		?>
		<div class="tf-map-markers" data-no-markers="<?php echo JText::_('NR_CREATE_YOUR_FIRST_MARKER'); ?>">
			<strong class="tf-map-markers--title"><?php echo JText::_('NR_MARKERS'); ?></strong>
			<div class="tf-map-markers--list">
					...
					foreach ($options['markers'] as $index => $marker)
					{
						...
						<div class="tf-map-markers--list--item" data-id="<?php echo $marker['id']; ?>">
							...
							<div class="tf-map-markers--list--item--actions">
								<a href="#" class="tf-map-markers--list--item--actions--edit" data-bs-toggle="modal" data-bs-target="#tfMapEditorMarkerEditModal" data-toggle="modal" data-target="#tfMapEditorMarkerEditModal" title="<?php echo JText::_('NR_MAP_EDITOR_MARKER_EDIT'); ?>">
								...
								<a href="#" class="tf-map-markers--list--item--actions--delete" title="<?php echo JText::_('NR_MAP_EDITOR_MARKER_DELETE'); ?>">
				...
				{
					echo JText::_('NR_CREATE_YOUR_FIRST_MARKER');
				}
				?>
			</div>
			...
			<a href="#" class="btn btn-primary tf-mapeditor-add-new-marker" data-bs-toggle="modal" data-toggle="modal" data-bs-target="#tfMapEditorMarkerAddModal" data-target="#tfMapEditorMarkerAddModal"><?php echo JText::_('NR_ADD_MARKER'); ?></a>
			<?php
			if (!$options['pro'])
			{
				...
				<div class="tf-mapeditor-add-unlimited-markers is-hidden">
					<a href="#" class="btn btn-danger" data-pro-only="<?php echo JText::_('NR_UNLIMITED_MARKERS'); ?>">
						<?php echo \JText::_('NR_ADD_MARKER'); ?>
