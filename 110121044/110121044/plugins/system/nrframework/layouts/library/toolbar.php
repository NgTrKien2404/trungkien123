        ...
        <div class="item sorting-selector-item">
            <div class="sort-wrapper">
                <div class="sorting-selected-label">
                    <span class="selected-label"><?php echo \JText::_('NR_TRENDING'); ?></span>
                ...
                <ul class="sorting-selector-items">
                    <li data-value="featured"><?php echo \JText::_('NR_FEATURED'); ?></li>
                    <li data-value="popularity"><?php echo \JText::_('NR_POPULAR'); ?></li>
                    <li data-value="trending" class="selected"><?php echo \JText::_('NR_TRENDING'); ?></li>
