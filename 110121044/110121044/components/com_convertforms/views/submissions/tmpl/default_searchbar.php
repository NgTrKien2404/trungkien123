...
<form method="get" class="convertforms-submissions-search-bar">
    <input type="text" name="q" value="<?php echo $query; ?>" placeholder="<?php echo JText::_('COM_CONVERTFORMS_SEARCH_HINT'); ?>" />
    <?php if ($query): ?>
...
<?php if ($query): ?>
    <div class="convertforms-submissions-search-bar-info">
        <?php echo '<p>' . JText::sprintf('COM_CONVERTFORMS_SEARCH_RESULTS_FOR', $this->total_submissions, $query) . '</p>'; ?>
    </div>
<?php endif; ?>
<script>
